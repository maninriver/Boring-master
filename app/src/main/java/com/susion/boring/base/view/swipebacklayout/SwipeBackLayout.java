...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link com.xingin.xhs.view.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.xingin.xhs.view.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
